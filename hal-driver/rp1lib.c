...
extern int rtapi_open_as_root(const char *path, int flags);
...
{
    rp1_gpio_fsel_result result = { -1, -1 };
    int best_fsel = -1;
...
int rt_rp1lib_init(void)
{
    ...
    DEBUG_PRINT("Initialising RP1 library (rt): %s\n", __func__);
